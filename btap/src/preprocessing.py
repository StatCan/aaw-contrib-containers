...
def read_weather(tenant,bucket,path):
    ...
    Args:
        tenant: default value is standard
        bucket: nrcan-btap
        path_elec: file path where data is to be read from in minio. In the case of electric value, this would be path to the electric hourly energy file
        path_gas: This would be path to the gas hourly energy file. This is optional 
